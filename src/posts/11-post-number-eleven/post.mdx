...
![tascam multitrack recorder](./images/ludwigponder.jpg)
...
I use an app called <a href="https://play.google.com/store/apps/details?id=me.jlabs.voicerecorder&hl=en_US" rel="noopener noreferrer" target="_blank">
Voice Recorder (available on Google Play)</a> but any recorder will do, as long as
...
Many times I will record the melody using gibberish lyrics that just sort of vaguely sounds
...
to where to go next. Listening to the gibberish lyrics, trying to pluck words out. Listening
...
**Step 4:** 
Now I record myself using a multi-track recorder. These days I have been using a <a href="https://amzn.to/2PhoTXX" rel="noopener noreferrer" target="_blank">Tascam DP-03SD 8 Track
Recorder</a>. I usually use two mics, one for guitar, one for vocals. The goal here is to play
it all the way through, without making a mistake.

![tascam multitrack recorder](./images/tascam.jpg)
...
![tascam multitrack recorder](./images/reaper.jpg)
