...
red when flat, yellow when sharp, and green when in tune.

<br/>

![tuner on ukulele head](./images/tunerclip.jpg)

3. The clip is padded, so it hasn't damaged any of my instruments. Some that I have owned in the past,
left a mark on the instrument head where it was clipped on. Not this one. Speaking of the clip,
I like how it is adjustable, so that it can be positioned for best viewability while playing.
